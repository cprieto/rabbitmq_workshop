...
async def consume(channel, exchange, name: str, key: str):
  ...
  # Important: In fanout exchange, routking keys do nothing!
...
async def main():
  ...
  exchange = await channel.declare_exchange('sample_topic', aio_pika.ExchangeType.FANOUT)
...
if __name__ == '__main__':
  print('[underline]Fanout exchange example[/underline]\n')
